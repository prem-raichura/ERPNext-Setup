...
- 🐳 Custom Docker image with bundled ERPNext + HRMS
- ⚙️ Clean `compose.yaml` & `.env` workflow
- 📦 App bundling via `apps.json`
- 🔁 Easy upgrades & app additions
- 👨‍💻 Developer & CI-friendly setup
...
> [!TIP]  
> Allocate at least **6–8 GB RAM** to Docker for smooth ERPNext operation.
...
⏳ Build time: **10–15 minutes** (depends on internet & system resources)
